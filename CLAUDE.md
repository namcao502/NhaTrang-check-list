...
| `components/ChecklistItem.tsx` | Single item row with checkbox, inline label rename (with tag badge inline in a `flex items-baseline` wrapper), inline note editor, and delete button |
