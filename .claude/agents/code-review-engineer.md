...
3. Review against these criteria:
   ...
   - **Conventions**: Matches existing component/hook patterns, Vietnamese UI text, correct Tailwind tokens?
   - **State integrity**: `useChecklist` remains the single source of truth, localStorage key unchanged?
